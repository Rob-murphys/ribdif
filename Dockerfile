...
RUN conda create -n ribdif python=3.11 -y \
    ...
    && pip install --no-cache-dir pandas==1.5.2 biopython==1.80 numpy==1.24.1 matplotlib==3.6.2 seaborn==0.12.2 scipy==1.10.0 networkx==3.0 fastcluster==1.2.6 chardet==5.1.0
