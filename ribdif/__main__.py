...
from custom_exceptions import EmptyFileError, IncompatiablityError, IncorrectFormatError, StopError
...
def parse_args():
    ...
    group2.add_argument("-w", "--whole-genome", dest = "whole", 
                        help = "Indicate the primers given are to be run on the whole genome so no barrnap, ani (Required if your primers are non 16S). Mutually exclusive with --ani",
                        choices = ["on", "off"],
                        default = "off")
